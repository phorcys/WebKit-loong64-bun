...
macro(WEBKIT_OPTION_BEGIN)
    ...
    elseif (WTF_CPU_LOONGARCH64)
        set(ENABLE_JIT_DEFAULT ON)
        set(ENABLE_FTL_DEFAULT ON)
        set(ENABLE_WEBASSEMBLY_BBQJIT_DEFAULT ON)
    ...
    if (NOT DEFINED ENABLE_WEBASSEMBLY_BBQJIT_DEFAULT)
        set(ENABLE_WEBASSEMBLY_BBQJIT_DEFAULT ${ENABLE_FTL_DEFAULT})
    endif ()
    ...
    WEBKIT_OPTION_DEFINE(ENABLE_WEBASSEMBLY_BBQJIT "Toggle WebAssembly BBQ JIT support" PRIVATE ${ENABLE_WEBASSEMBLY_BBQJIT_DEFAULT})
